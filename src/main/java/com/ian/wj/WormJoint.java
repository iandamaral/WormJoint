...
public class WormJoint extends JFrame {
	...
	public Graphics2D gx;				// Rotação
	public Image gImagem;
	protected int largura;
	protected int altura;
	
	// Dimensões da viewport (janela de renderização)
	public int larguraImagem;
	public int alturaImagem;
	
	// Dimensões do nosso mundo (onde os objetos estão trabalhando)
	public float larguraMundo;
	public float alturaMundo;
	
	public PainelGrafico pGrafico;
	...
	public float fatorEscalaVisual = 4.0f;  
	
	// Variáveis específicas deste laboratório (devem ser substituídas)
	...
	public void initBox2D() {
		...
		// A origem do eixo das ordenadas e no canto inferior, e não no superior
		...
		// Atribuimos uma forma retangular à  fixture do chão
